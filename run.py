...
def get_players_data():
    ...
    def get_initial_life_points():
        while True:
            game_mode = input("""
Enter game mode (Standard or Commander):\n""").lower()
            print()
...
def calculate_life(player1, player2):
    while True:
        get_new_score = input("""
Enter action (e.g., 'Player1 -3' to subtract 3 
life points from Player1 or 'exit' to quit):
""")
        ...
        try:
            ...
            print("""
Invalid input. Please enter the action in the correct format.
""")
            continue
